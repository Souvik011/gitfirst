...
function buyMaterials(){
    return new Promise((res,rej) => {
        setTimeout(() => {
            res("Marerials to build a house has been bought ")
        },2000)
    })
}
...
function planning(){
    return new Promise((res,rej) => {
        setTimeout(() => {
            res("Planning to build a house ")
        },6000)
    })
}
// Promise.Then Method Structure 

// planning().then((msg) =>{
//     console.log(msg);
//     buyMaterials().then((msg) => {
//         console.log(msg);
//         buildAhouse().then((msg) => {
//             console.log(msg);
//         })
//     })
// })

//asycn await Structure 

async function houseBuildingProcess(){
    const msg = await planning();
    console.log(msg);
    const msg2 = await buyMaterials();
    console.log(msg2);
    const msg3 = await buildAhouse();
    console.log(msg3);
}
